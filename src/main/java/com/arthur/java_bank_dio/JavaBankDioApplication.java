package com.arthur.java_bank_dio;
...
public class JavaBankDioApplication {
    ...
    private static void createWalletInvestment() throws AccountNotFoundException{
    ...
    private static void incInvestment() throws AccountNotFoundException{
    ...
    private static void rescueInvestment() throws AccountNotFoundException{
